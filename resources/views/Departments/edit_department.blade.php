                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="department_name" name="department_name" placeholder="Please, Enter Department Name" value="{{old('capacity' , $departments->department_name)}}">
